...
const Sidebar = ({ dashbaordValues, open, setOpen }: SidebarProps) => {
  return (
    <aside
      className={`max-lg:absolute max-lg:left-0 max-lg:top-0 z-[999] flex h-screen transition-all flex-col bg-[#FFF2FD] text-black border-r border-light-pink ${
        open ? "translate-x-0 w-[280px]" : "-translate-x-[270px] lg:w-0"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
