...
export const ModalUploadLandscape: React.FC<ModalPhotoUploadProps> = ({
  heading,
  size,
}) => {
  ...
  return (
    <div className={`my-3`}>
      ...
      <div className="border w-full h-[221px]  p-4 rounded-lg  border-black/30 ">
        {imageSrc ? (
          ...
          <div className=" flex items-center h-full justify-center">
            ...
            >
              ...
              <div className="text-center">
                <h5 className="mt-2 text-xl">Upload Image</h5>
