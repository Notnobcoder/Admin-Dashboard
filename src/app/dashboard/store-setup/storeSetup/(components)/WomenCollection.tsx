    ...
    <div className="lg:flex items-center flex-row-reverse justify-between">
      ...
      {options ? (
        <div className="flex items-center justify-center gap-8 ">
          <button
            className={`border py-2 border-dark-pink px-4 font-medium rounded-md shadow-dark-pink hover:border-dark-pink border-dark-pink transition-all flex items-center gap-3`}
          >
            <Image
...
export default function WomenCollections({
  ...
  return (
    <div className="w-full font-jost">
        ...
        {CARD_DETAILS.map((i) => {
          return (
            <div
              ...
              key={i.id}
            >
              <CardCategory item={i} type="Women" />
            </div>
          );
        })}
      </div>
      <div className="mt-16">
        <h3 className="text-4xl my-4 font-bold">Ceremonial Bespoke</h3>
        <div className=" grid md:grid-cols-8 grid-cols-1 gap-5">
          {CARD_DETAILS2.map((i) => {
            return (
              <div
      ...
      <div className="mt-16">
        <h3 className="text-4xl my-4 font-bold">Casual Bespoke</h3>
        <div className=" grid md:grid-cols-8 grid-cols-1 gap-5">
          {CARD_DETAILS3.map((i) => {
            return (
              <div
