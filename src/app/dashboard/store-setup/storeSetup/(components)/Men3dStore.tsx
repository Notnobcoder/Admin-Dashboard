    ...
    <div className="lg:flex items-center flex-row-reverse justify-between">
      ...
      {options ? (
        <div className="flex items-center justify-center gap-8 ">
          ...
          <button
            className={` border  py-3 px-6 border-dark-pink font-medium rounded-md shadow-dark-pink hover:border-dark-pink transition-all flex items-center gap-3`}
          >
            <Image
...
export default function Men3dStore({
  onGenderChange,
}: {
  onGenderChange: () => void;
}) {
    ...
    <div className="w-full font-jost">
      ...
      <div className="flex items-center gap-4 my-2">
        <Image
          ...
          alt="Image props"
        />
        <h3 className="text-4xl  font-jost font-normal">Men</h3>
      </div>
      ...
      <div className="mt-16">
        <h3 className="text-4xl my-4 font-jost font-bold">Casual Bespoke</h3>
        <div className=" grid md:grid-cols-8 grid-cols-1 gap-5">
          {CARD_DETAILS3.map((i) => {
            return (
              <div
