...
export default function AddMeasurementModal({
  ...
  return (
    <Modal
      ...
      className="p-1.5 md:max-w-xs max-w-[320px] rounded-2xl max-h-[90vh]"
      placement="center"
    >
            ...
            <ModalBody className="overflow-y-auto custom-scrollbar md:p-5 p-4">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    className="border border-black/30 px-4 py-2 rounded-lg placeholder:text-sm"
                    type="text"
                ...
                <div className="mx-auto">
                  <Button
                    ...
                    isDisabled={awsStyleImage ? false : true}
                    onClick={() => {
                      // handleNewStyle();
                      onClose();
                    }}
